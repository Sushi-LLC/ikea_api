...
Rails.application.configure do
  ...
  # Отключено для работы с kamal-proxy (SSL будет на уровне proxy)
  ...
  config.active_job.queue_name_prefix = "ikea_api_production"
  ...
  # ActiveStorage configuration - use disk service in production (can be changed to S3 later)
